...
public class CreateOrderTest extends TestBase {
    ...
    @Test
    void createOrderWithPSTest() throws Exception {
        apiClient.initBouquet(BouquetType.PS);
...
//                .assertRecipientInfo(deliveryTimeFrom);
    ...
    //переделать на заказ с 2 разными типами букетов когда это будет можно
    @Test
...
//    }
    ...
    @Test
    void removeFromCardTest() throws JsonProcessingException {
        apiClient.initBouquet(BouquetType.FLORIST_RU, false);
